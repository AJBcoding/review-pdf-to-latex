// Comment model, drafts persistence, submit + results round-trip, and bundle
// artifact shapes, shared between Electron main, preload, and renderer. This is
// the §8/§10 comment-and-roundtrip concern carved out of the former
// shared/types.ts god-file (roadmap X3); X5's discriminated anchor union lands
// here. Keep this surface minimal.
