// Engine subprocess + PDF I/O types shared between Electron main, preload, and
// renderer. Covers the `review-pdf` subprocess invocation surface, PDF health
// pre-flight, and reading PDF bytes / picking a PDF across the IPC boundary.
