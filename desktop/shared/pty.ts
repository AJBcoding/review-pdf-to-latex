// §9.2 embedded-Claude pty surface shared between Electron main, preload, and
// renderer: the conversational pty, the toolbar/worker ptys (Create Context /
// Sling), their progress markers, and Fresh Start respawn.
